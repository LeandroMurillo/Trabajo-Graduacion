...
DROP PROCEDURE IF EXISTS `activarPostulante`;
...
DELIMITER //
CREATE PROCEDURE activarPostulante(
  IN pIdPostulante CHAR(28)
)
BEGIN
  ...
  -- Solo se activa desde Pendiente
  ...
  -- Si está inactivo, no debería activarse desde enlace de correo
  ELSEIF vEstado = 'I' THEN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'POSTULANTE_INACTIVO';
