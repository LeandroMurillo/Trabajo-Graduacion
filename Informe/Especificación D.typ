...
#figure(
  box(
    ...
    radius: 4pt,
    outset: 0pt,
    image("EspecificacionD/ModeloRelacional.jpg"),
  ),
  caption: [Modelo Relacional de SGVac],
)

#pagebreak()
=== Diccionario de datos

#set raw(syntaxes: "DataDictionary.sublime-syntax")

#let text-code(file-path) = {
  block(
    inset: 12pt,
    width: 100%,
    stroke: 0.5pt + rgb("#333333"),
    radius: 4pt,
    {
      ...
      raw(read(file-path), lang: "dict", block: true)
    },
  )
}

#text-code("DiccionarioDatos.txt")
